        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              progressMessage == null ? SizedBox(height: 1.0,) :
...
class _Controller {
  ...
  void update() async {
    ...
    try {
      ...
      MyDialog.showSnackBar(context: state.context, message: 'Update PhotoMemo error. $e',);
    }
  ...
  void saveSharedWith(String? value) {
    if (value != null && value.trim().length != 0) {
      ...
      tempMemo.sharedWith.addAll(value.trim().split(
          RegExp('(,| )+'))); //second parenthesis may actually need to be }
    }
  }
}
